...
2. [The Situation Assessment Surveys: An Evaluation] (http://ras.org.in/index.php?Article=the_situation_assessment_surveys&q=biplab&keys=biplab)
...
The seven R files contain the script and comments for basic analysis of the unit-level data. All these files use data from both the visits.
